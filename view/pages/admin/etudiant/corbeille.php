...
$trash = $repo->getTrashByRole('Etudiant');
?>
<!DOCTYPE html>
<html lang="fr">
    ...
    <div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
        ...
        <div id="content" class="content">
            <ol class="breadcrumb float-xl-right">
                <li class="breadcrumb-item"><a href="ListeEtudiant" class="btn btn-sm btn-success text-white"><i class="fa fa-arrow-left"></i> Retour</a></li>
            </ol>
            <h1 class="page-header"># Corbeille Étudiants</h1>
            <div class="panel panel-danger">
                <div class="panel-heading"><h4 class="panel-title">Comptes étudiants désactivés</h4></div>
